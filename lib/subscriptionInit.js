...
function getSubscriptions()
{
  ...
  let adsSubscription = Subscription.fromURL("https://easylist.to/easylist/easylist.txt")
  subscriptions.push(adsSubscription)

  let annoyanceSubscription = Subscription.fromURL("https://easylist.to/easylist/fanboy-annoyance.txt")
  subscriptions.push(annoyanceSubscription) 

  let privacySubscription = Subscription.fromURL("https://easylist.to/easylist/easyprivacy.txt")
  subscriptions.push(privacySubscription)
